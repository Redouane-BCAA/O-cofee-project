...
INSERT INTO coffee (name, description, reference, origin, price, characteristic, available) VALUES
...
ALTER TABLE coffee ADD COLUMN categorie_id INT REFERENCES categorie(id);
